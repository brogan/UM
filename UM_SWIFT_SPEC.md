...
| Animation | Phase, motion set, path, sequence | Phase + motion set, Position Driver, Sprite Set |
...
| **Sprite layer** | LAYER DRIVERS (Blend, Opacity, Offset) — render path already wired; Distortion hidden in UI | ✓ Built 2026-06-25 |
| **Sprite layer** | Direct drawing with active Sprite Set (tap palette row to activate; auto-assigned on place) | ✓ Built 2026-06-25 |
